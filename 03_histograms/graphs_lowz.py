...
#GALAXIAS DEL REDSHIFT DE CALIFA
mask_z1=(t['NSA_Z']<=0.03)



print('\nTotal de galaxias', np.sum(mask_z1))
print('Galaxias con flag: ', np.sum((t['FLAG']=='REVISAR') & mask_z1))
print('Galaxias peques: ', np.sum(~mask_px & mask_z1))
print('Galaxias utilizadas: ', np.sum(mask_noflag & mask_z1))
...
#BAR A + INTERACTING
barA_nosig_b1=np.sum(d_stellar[mask_z1 & mask_noflag & mask_barA & mask_nosig]<fiber_size)
barA_nosig_b2=np.sum((d_stellar[mask_z1 & mask_noflag & mask_barA & mask_nosig]>fiber_size) & (d_stellar[mask_z1 & mask_noflag  & mask_barA & mask_nosig]<2*fiber_size)) 
barA_nosig_b3=np.sum(d_stellar[mask_z1 & mask_z1 & mask_noflag  & mask_barA & mask_nosig]>2*fiber_size)
#BAR A + ISOLATED
barA_sig_b1=np.sum(d_stellar[mask_z1 & mask_noflag  & mask_barA & mask_sig]<fiber_size)
barA_sig_b2=np.sum((d_stellar[mask_z1 & mask_noflag  & mask_barA & mask_sig]>fiber_size) & (d_stellar[mask_z1 & mask_noflag  & mask_barA & mask_sig]<2*fiber_size)) 
barA_sig_b3=np.sum(d_stellar[mask_z1 & mask_noflag  & mask_barA & mask_sig]>2*fiber_size)
#BAR AB + INTERACTING
barAB_nosig_b1=np.sum(d_stellar[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]<fiber_size)
barAB_nosig_b2=np.sum((d_stellar[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]>fiber_size) & (d_stellar[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]<2*fiber_size)) 
barAB_nosig_b3=np.sum(d_stellar[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]>2*fiber_size)
#BAR AB + ISOLATED
barAB_sig_b1=np.sum(d_stellar[mask_z1 & mask_noflag  & mask_barAB & mask_sig]<fiber_size)
barAB_sig_b2=np.sum((d_stellar[mask_z1 & mask_noflag  & mask_barAB & mask_sig]>fiber_size) & (d_stellar[mask_z1 & mask_noflag  & mask_barAB & mask_sig]<2*fiber_size)) 
barAB_sig_b3=np.sum(d_stellar[mask_z1 & mask_noflag  & mask_barAB & mask_sig]>2*fiber_size)
#BAR B + INTERACTING
barB_nosig_b1=np.sum(d_stellar[mask_z1 & mask_noflag  & mask_barB & mask_nosig]<fiber_size)
barB_nosig_b2=np.sum((d_stellar[mask_z1 & mask_noflag  & mask_barB & mask_nosig]>fiber_size) & (d_stellar[mask_z1 & mask_noflag  & mask_barB & mask_nosig]<2*fiber_size)) 
barB_nosig_b3=np.sum(d_stellar[mask_z1 & mask_noflag  & mask_barB & mask_nosig]>2*fiber_size)
#BAR B + ISOLATED
barB_sig_b1=np.sum(d_stellar[mask_z1 & mask_noflag  & mask_barB & mask_sig]<fiber_size)
barB_sig_b2=np.sum((d_stellar[mask_z1 & mask_noflag  & mask_barB & mask_sig]>fiber_size) & (d_stellar[mask_z1 & mask_noflag  & mask_barB & mask_sig]<2*fiber_size)) 
barB_sig_b3=np.sum(d_stellar[mask_z1 & mask_noflag  & mask_barB & mask_sig]>2*fiber_size)
...
#BAR A + INTERACTING
barA_nosig_b1=np.sum(d_ha[mask_z1 & mask_noflag  & mask_barA & mask_nosig]<1.3)
barA_nosig_b2=np.sum((d_ha[mask_z1 & mask_noflag  & mask_barA & mask_nosig]>1.3) & (d_ha[mask_z1 & mask_noflag  & mask_barA & mask_nosig]<2.7)) 
barA_nosig_b3=np.sum(d_ha[mask_z1 & mask_noflag  & mask_barA & mask_nosig]>2.7)
#BAR A + ISOLATED
barA_sig_b1=np.sum(d_ha[mask_z1 & mask_noflag  & mask_barA & mask_sig]<1.3)
barA_sig_b2=np.sum((d_ha[mask_z1 & mask_noflag  & mask_barA & mask_sig]>1.3) & (d_ha[mask_z1 & mask_noflag  & mask_barA & mask_sig]<2.7)) 
barA_sig_b3=np.sum(d_ha[mask_z1 & mask_noflag  & mask_barA & mask_sig]>2.7)
#BAR AB + INTERACTING
barAB_nosig_b1=np.sum(d_ha[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]<1.3)
barAB_nosig_b2=np.sum((d_ha[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]>1.3) & (d_ha[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]<2.7)) 
barAB_nosig_b3=np.sum(d_ha[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]>2.7)
#BAR AB + ISOLATED
barAB_sig_b1=np.sum(d_ha[mask_z1 & mask_noflag  & mask_barAB & mask_sig]<1.3)
barAB_sig_b2=np.sum((d_ha[mask_z1 & mask_noflag  & mask_barAB & mask_sig]>1.3) & (d_ha[mask_z1 & mask_noflag  & mask_barAB & mask_sig]<2.7)) 
barAB_sig_b3=np.sum(d_ha[mask_z1 & mask_noflag  & mask_barAB & mask_sig]>2.7)
#BAR B + INTERACTING
barB_nosig_b1=np.sum(d_ha[mask_z1 & mask_noflag  & mask_barB & mask_nosig]<1.3)
barB_nosig_b2=np.sum((d_ha[mask_z1 & mask_noflag  & mask_barB & mask_nosig]>1.3) & (d_ha[mask_z1 & mask_noflag  & mask_barB & mask_nosig]<2.7)) 
barB_nosig_b3=np.sum(d_ha[mask_z1 & mask_noflag  & mask_barB & mask_nosig]>2.7)
#BAR B + ISOLATED
barB_sig_b1=np.sum(d_ha[mask_z1 & mask_noflag  & mask_barB & mask_sig]<1.3)
barB_sig_b2=np.sum((d_ha[mask_z1 & mask_noflag  & mask_barB & mask_sig]>1.3) & (d_ha[mask_z1 & mask_noflag  & mask_barB & mask_sig]<2.7)) 
barB_sig_b3=np.sum(d_ha[mask_z1 & mask_noflag  & mask_barB & mask_sig]>2.7)
...
#BAR A + INTERACTING
barA_nosig_b1=np.sum(d_oiii[mask_z1 & mask_noflag  & mask_barA & mask_nosig]<1.3)
barA_nosig_b2=np.sum((d_oiii[mask_z1 & mask_noflag  & mask_barA & mask_nosig]>1.3) & (d_oiii[mask_z1 & mask_noflag  & mask_barA & mask_nosig]<2.7)) 
barA_nosig_b3=np.sum(d_oiii[mask_z1 & mask_noflag  & mask_barA & mask_nosig]>2.7)
#BAR A + ISOLATED
barA_sig_b1=np.sum(d_oiii[mask_z1 & mask_noflag  & mask_barA & mask_sig]<1.3)
barA_sig_b2=np.sum((d_oiii[mask_z1 & mask_noflag  & mask_barA & mask_sig]>1.3) & (d_oiii[mask_z1 & mask_noflag  & mask_barA & mask_sig]<2.7)) 
barA_sig_b3=np.sum(d_oiii[mask_z1 & mask_noflag  & mask_barA & mask_sig]>2.7)
#BAR AB + INTERACTING
barAB_nosig_b1=np.sum(d_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]<1.3)
barAB_nosig_b2=np.sum((d_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]>1.3) & (d_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]<2.7)) 
barAB_nosig_b3=np.sum(d_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]>2.7)
#BAR AB + ISOLATED
barAB_sig_b1=np.sum(d_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_sig]<1.3)
barAB_sig_b2=np.sum((d_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_sig]>1.3) & (d_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_sig]<2.7)) 
barAB_sig_b3=np.sum(d_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_sig]>2.7)
#BAR B + INTERACTING
barB_nosig_b1=np.sum(d_oiii[mask_z1 & mask_noflag  & mask_barB & mask_nosig]<1.3)
barB_nosig_b2=np.sum((d_oiii[mask_z1 & mask_noflag  & mask_barB & mask_nosig]>1.3) & (d_oiii[mask_z1 & mask_noflag  & mask_barB & mask_nosig]<2.7)) 
barB_nosig_b3=np.sum(d_oiii[mask_z1 & mask_noflag  & mask_barB & mask_nosig]>2.7)
#BAR B + ISOLATED
barB_sig_b1=np.sum(d_oiii[mask_z1 & mask_noflag  & mask_barB & mask_sig]<1.3)
barB_sig_b2=np.sum((d_oiii[mask_z1 & mask_noflag  & mask_barB & mask_sig]>1.3) & (d_oiii[mask_z1 & mask_noflag  & mask_barB & mask_sig]<2.7)) 
barB_sig_b3=np.sum(d_oiii[mask_z1 & mask_noflag  & mask_barB & mask_sig]>2.7)
...
#fig.suptitle('Galaxies with z<0.03')
fig.savefig('califa_offset01.png')
plt.show()
...
#BAR A + INTERACTING
barA_nosig_b1=np.sum(d_st_ha[mask_z1 & mask_noflag  & mask_barA & mask_nosig]<fiber_size)
barA_nosig_b2=np.sum((d_st_ha[mask_z1 & mask_noflag  & mask_barA & mask_nosig]>fiber_size) & (d_st_ha[mask_z1 & mask_noflag  & mask_barA & mask_nosig]<2*fiber_size)) 
barA_nosig_b3=np.sum(d_st_ha[mask_z1 & mask_noflag  & mask_barA & mask_nosig]>2*fiber_size)
#BAR A + ISOLATED
barA_sig_b1=np.sum(d_st_ha[mask_z1 & mask_noflag  & mask_barA & mask_sig]<fiber_size)
barA_sig_b2=np.sum((d_st_ha[mask_z1 & mask_noflag  & mask_barA & mask_sig]>fiber_size) & (d_st_ha[mask_z1 & mask_noflag  & mask_barA & mask_sig]<2*fiber_size)) 
barA_sig_b3=np.sum(d_st_ha[mask_z1 & mask_noflag  & mask_barA & mask_sig]>2*fiber_size)
#BAR AB + INTERACTING
barAB_nosig_b1=np.sum(d_st_ha[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]<fiber_size)
barAB_nosig_b2=np.sum((d_st_ha[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]>fiber_size) & (d_st_ha[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]<2*fiber_size)) 
barAB_nosig_b3=np.sum(d_st_ha[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]>2*fiber_size)
#BAR AB + ISOLATED
barAB_sig_b1=np.sum(d_st_ha[mask_z1 & mask_noflag  & mask_barAB & mask_sig]<fiber_size)
barAB_sig_b2=np.sum((d_st_ha[mask_z1 & mask_noflag  & mask_barAB & mask_sig]>fiber_size) & (d_st_ha[mask_z1 & mask_noflag  & mask_barAB & mask_sig]<2*fiber_size)) 
barAB_sig_b3=np.sum(d_st_ha[mask_z1 & mask_noflag  & mask_barAB & mask_sig]>2*fiber_size)
#BAR B + INTERACTING
barB_nosig_b1=np.sum(d_st_ha[mask_z1 & mask_noflag  & mask_barB & mask_nosig]<fiber_size)
barB_nosig_b2=np.sum((d_st_ha[mask_z1 & mask_noflag  & mask_barB & mask_nosig]>fiber_size) & (d_st_ha[mask_z1 & mask_noflag  & mask_barB & mask_nosig]<2*fiber_size)) 
barB_nosig_b3=np.sum(d_st_ha[mask_z1 & mask_noflag  & mask_barB & mask_nosig]>2*fiber_size)
#BAR B + ISOLATED
barB_sig_b1=np.sum(d_st_ha[mask_z1 & mask_noflag  & mask_barB & mask_sig]<fiber_size)
barB_sig_b2=np.sum((d_st_ha[mask_z1 & mask_noflag  & mask_barB & mask_sig]>fiber_size) & (d_st_ha[mask_z1 & mask_noflag  & mask_barB & mask_sig]<2*fiber_size)) 
barB_sig_b3=np.sum(d_st_ha[mask_z1 & mask_noflag  & mask_barB & mask_sig]>2*fiber_size)
...
#BAR A + INTERACTING
barA_nosig_b1=np.sum(d_st_oiii[mask_z1 & mask_noflag  & mask_barA & mask_nosig]<fiber_size)
barA_nosig_b2=np.sum((d_st_oiii[mask_z1 & mask_noflag  & mask_barA & mask_nosig]>fiber_size) & (d_st_oiii[mask_z1 & mask_noflag  & mask_barA & mask_nosig]<2*fiber_size)) 
barA_nosig_b3=np.sum(d_st_oiii[mask_z1 & mask_noflag  & mask_barA & mask_nosig]>2*fiber_size)
#BAR A + ISOLATED
barA_sig_b1=np.sum(d_st_oiii[mask_z1 & mask_noflag  & mask_barA & mask_sig]<fiber_size)
barA_sig_b2=np.sum((d_st_oiii[mask_z1 & mask_noflag  & mask_barA & mask_sig]>fiber_size) & (d_st_oiii[mask_z1 & mask_noflag  & mask_barA & mask_sig]<2*fiber_size)) 
barA_sig_b3=np.sum(d_st_oiii[mask_z1 & mask_noflag  & mask_barA & mask_sig]>2*fiber_size)
#BAR AB + INTERACTING
barAB_nosig_b1=np.sum(d_st_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]<fiber_size)
barAB_nosig_b2=np.sum((d_st_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]>fiber_size) & (d_st_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]<2*fiber_size)) 
barAB_nosig_b3=np.sum(d_st_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]>2*fiber_size)
#BAR AB + ISOLATED
barAB_sig_b1=np.sum(d_st_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_sig]<fiber_size)
barAB_sig_b2=np.sum((d_st_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_sig]>fiber_size) & (d_st_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_sig]<2*fiber_size)) 
barAB_sig_b3=np.sum(d_st_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_sig]>2*fiber_size)
#BAR B + INTERACTING
barB_nosig_b1=np.sum(d_st_oiii[mask_z1 & mask_noflag  & mask_barB & mask_nosig]<fiber_size)
barB_nosig_b2=np.sum((d_st_oiii[mask_z1 & mask_noflag  & mask_barB & mask_nosig]>fiber_size) & (d_st_oiii[mask_z1 & mask_noflag  & mask_barB & mask_nosig]<2*fiber_size)) 
barB_nosig_b3=np.sum(d_st_oiii[mask_z1 & mask_noflag  & mask_barB & mask_nosig]>2*fiber_size)
#BAR B + ISOLATED
barB_sig_b1=np.sum(d_st_oiii[mask_z1 & mask_noflag  & mask_barB & mask_sig]<fiber_size)
barB_sig_b2=np.sum((d_st_oiii[mask_z1 & mask_noflag  & mask_barB & mask_sig]>fiber_size) & (d_st_oiii[mask_z1 & mask_noflag  & mask_barB & mask_sig]<2*fiber_size)) 
barB_sig_b3=np.sum(d_st_oiii[mask_z1 & mask_noflag  & mask_barB & mask_sig]>2*fiber_size)
...
#BAR A + INTERACTING
barA_nosig_b1=np.sum(d_ha_oiii[mask_z1 & mask_noflag  & mask_barA & mask_nosig]<fiber_size)
barA_nosig_b2=np.sum((d_ha_oiii[mask_z1 & mask_noflag  & mask_barA & mask_nosig]>fiber_size) & (d_ha_oiii[mask_z1 & mask_noflag  & mask_barA & mask_nosig]<2*fiber_size)) 
barA_nosig_b3=np.sum(d_ha_oiii[mask_z1 & mask_noflag  & mask_barA & mask_nosig]>2*fiber_size)
#BAR A + ISOLATED
barA_sig_b1=np.sum(d_ha_oiii[mask_z1 & mask_noflag  & mask_barA & mask_sig]<fiber_size)
barA_sig_b2=np.sum((d_ha_oiii[mask_z1 & mask_noflag  & mask_barA & mask_sig]>fiber_size) & (d_ha_oiii[mask_z1 & mask_noflag  & mask_barA & mask_sig]<2*fiber_size)) 
barA_sig_b3=np.sum(d_ha_oiii[mask_z1 & mask_noflag  & mask_barA & mask_sig]>2*fiber_size)
#BAR AB + INTERACTING
barAB_nosig_b1=np.sum(d_ha_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]<fiber_size)
barAB_nosig_b2=np.sum((d_ha_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]>fiber_size) & (d_ha_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]<2*fiber_size)) 
barAB_nosig_b3=np.sum(d_ha_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_nosig]>2*fiber_size)
#BAR AB + ISOLATED
barAB_sig_b1=np.sum(d_ha_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_sig]<fiber_size)
barAB_sig_b2=np.sum((d_ha_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_sig]>fiber_size) & (d_ha_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_sig]<2*fiber_size)) 
barAB_sig_b3=np.sum(d_ha_oiii[mask_z1 & mask_noflag  & mask_barAB & mask_sig]>2*fiber_size)
#BAR B + INTERACTING
barB_nosig_b1=np.sum(d_ha_oiii[mask_z1 & mask_noflag  & mask_barB & mask_nosig]<fiber_size)
barB_nosig_b2=np.sum((d_ha_oiii[mask_z1 & mask_noflag  & mask_barB & mask_nosig]>fiber_size) & (d_ha_oiii[mask_z1 & mask_noflag  & mask_barB & mask_nosig]<2*fiber_size)) 
barB_nosig_b3=np.sum(d_ha_oiii[mask_z1 & mask_noflag  & mask_barB & mask_nosig]>2*fiber_size)
#BAR B + ISOLATED
barB_sig_b1=np.sum(d_ha_oiii[mask_z1 & mask_noflag  & mask_barB & mask_sig]<fiber_size)
barB_sig_b2=np.sum((d_ha_oiii[mask_z1 & mask_noflag  & mask_barB & mask_sig]>fiber_size) & (d_ha_oiii[mask_z1 & mask_noflag  & mask_barB & mask_sig]<2*fiber_size)) 
barB_sig_b3=np.sum(d_ha_oiii[mask_z1 & mask_noflag  & mask_barB & mask_sig]>2*fiber_size)
...
#fig.suptitle('Galaxies with z<0.03')
fig.savefig('califa_offset02.png')
plt.show()
